...
def find_fewshot_indices(dataset, n_shots):
  ...
  print("Finding few shot indicies : Count {}, Length {}".format(n_classes, n_shots))
  ...
  loader = torch.utils.data.DataLoader(dataset, batch_size=1024, shuffle=True, num_workers=0)#changing from 0 to 8
